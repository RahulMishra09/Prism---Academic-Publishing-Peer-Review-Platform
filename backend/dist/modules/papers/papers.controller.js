...
import { createPaperSchema, updatePaperSchema, rejectPaperSchema, listPapersSchema, } from "./papers.schema.js";
import { createPaper, getMyPapers, listPapers, getPaperById, updatePaper, submitPaper, approvePaper, rejectPaper, } from "./papers.service.js";
//  Helpers 
/**
...
export const list = async (req, res, next) => {
    try {
        ...
        const result = await listPapers(req.user.userId, req.user.role, parsed.data);
        sendSuccess(res, {
            statusCode: 200,
            message: "Papers retrieved successfully",
            data: result,
...
export const getOne = async (req, res, next) => {
    try {
        const paper = await getPaperById(param(req.params.id), req.user.userId, req.user.role);
        sendSuccess(res, {
            statusCode: 200,
...
export const update = async (req, res, next) => {
    try {
        ...
        const paper = await updatePaper(param(req.params.id), req.user.userId, parsed.data);
        sendSuccess(res, {
            statusCode: 200,
