...
export const listComments = async (paperId, query) => {
...
export const createComment = async (paperId, authorId, authorRole, input) => {
...
export const deleteComment = async (commentId, requesterId, requesterRole) => {
