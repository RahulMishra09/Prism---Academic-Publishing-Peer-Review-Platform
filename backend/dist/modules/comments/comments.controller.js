...
export const create = async (req, res, next) => {
    try {
        ...
        const comment = await createComment(param(req.params.paperId), req.user.userId, req.user.role, parsed.data);
        sendSuccess(res, {
            statusCode: 201,
...
export const remove = async (req, res, next) => {
    try {
        const result = await deleteComment(param(req.params.commentId), req.user.userId, req.user.role);
        sendSuccess(res, {
            statusCode: 200,
