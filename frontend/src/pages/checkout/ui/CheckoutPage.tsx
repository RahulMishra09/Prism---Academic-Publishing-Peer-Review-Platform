...
export const CheckoutPage: React.FC = () => {
    ...
    const handleCheckout = async (e: React.FormEvent) => {
        ...
        try {
            await fetchClient(`/checkout/article/${encodeURIComponent(doi || '')}`, {
                method: 'POST',
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <section className="bg-white border border-lumex-border rounded-lg p-6 mb-8">
                        ...
                        <div className="space-y-4 pt-4 border-t border-lumex-border">
                            ...
                            <label className={`block border rounded-lg p-4 cursor-pointer transition-colors ${accessType === '48h' ? 'bg-blue-50 border-lumex-blue' : 'border-gray-200 hover:border-blue-200'}`}>
                                <div className="flex justify-between items-start">
                                    <div className="flex gap-3">
                                        <input type="radio" name="accessType" value="48h" checked={accessType === '48h'} onChange={() => setAccessType('48h')} className="mt-1" />
                                        <div>
                            ...
                            <label className={`block border rounded-lg p-4 cursor-pointer transition-colors ${accessType === 'perpetual' ? 'bg-blue-50 border-lumex-blue' : 'border-gray-200 hover:border-blue-200'}`}>
                                <div className="flex justify-between items-start">
                                    <div className="flex gap-3">
                                        <input type="radio" name="accessType" value="perpetual" checked={accessType === 'perpetual'} onChange={() => setAccessType('perpetual')} className="mt-1" />
                                        <div>
                ...
                <div className="lg:col-span-1">
                    <section className="bg-gray-50 border border-lumex-border rounded-lg p-6 sticky top-20">
                        ...
                        <form onSubmit={(e) => void handleCheckout(e)} className="space-y-5">
                            <Stack>
                            ...
                            <div className="pt-6 border-t border-gray-200">
                                ...
                                <p className="text-xs text-center text-gray-500 mt-4 leading-relaxed">
                                    By processing this payment, you agree to our <Link to="/terms" className="text-lumex-blue hover:underline">Terms of Service</Link> and <Link to="/privacy-policy" className="text-lumex-blue hover:underline">Privacy Policy</Link>.
                                </p>
                            </div>
                        </form>
                    </section>
