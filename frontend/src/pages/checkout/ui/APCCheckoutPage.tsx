                        ...
                        <div className="space-y-3 mb-8">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <svg className="text-lumex-sub" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2" /><line x1="1" y1="10" x2="23" y2="10" /></svg>
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <svg className="text-lumex-sub" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z" /><path d="M6 12v5c3 3 9 3 12 0v-5" /></svg>
                        ...
                        {paymentMethod === 'card' ? (
                            <div className="space-y-4 mb-8">
                                <div className="space-y-2">
                                    ...
                                    <div className="p-3 bg-lumex-bg-deep/40 border border-lumex-border rounded-lg text-sm text-lumex-sub flex justify-between items-center">
                                        <span>•••• •••• •••• ••••</span>
                                    ...
                                    <p className="text-[10px] text-lumex-sub italic mt-1">Mock checkout: No real payment data is collected.</p>
                                </div>
                            </div>
                        ) : (
                            <div className="space-y-4 mb-8">
