...
export const ReviewForm: React.FC = () => {
    ...
    return (
        <Container className="py-12 max-w-4xl">
            ...
            <p className="text-lumex-muted mb-8">Manuscript ID: {id}</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 border border-lumex-border rounded-lg shadow-sm">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={criteria} className="flex justify-between items-center p-3 border border-lumex-border rounded-lg bg-lumex-bg-deep/40/50">
                ...
                <section>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                className="w-full p-4 border border-lumex-border rounded-lg outline-none focus:border-lumex-blue min-h-[120px] text-sm bg-lumex-bg-deep/40/30"
                ...
                <section>
                    ...
                    <div className="border-2 border-dashed border-lumex-border rounded-lg p-8 text-center bg-lumex-bg-deep/40/50">
                        <input type="file" className="hidden" id="review-upload" />
                        <label htmlFor="review-upload" className="cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="mx-auto text-lumex-sub mb-2">
                                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="17 8 12 3 7 8" /><line x1="12" y1="3" x2="12" y2="15" />
                            </svg>
                            <span className="text-sm font-bold text-lumex-blue">Upload Annotated Manuscript</span>
                            <span className="text-xs text-lumex-sub block mt-1">PDF, DOCX up to 10MB</span>
                        </label>
                    </div>
                </section>
